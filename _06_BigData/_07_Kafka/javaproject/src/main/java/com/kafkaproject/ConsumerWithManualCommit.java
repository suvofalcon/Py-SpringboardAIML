...
public class ConsumerWithManualCommit {
    ...
    public static void main(String[] args) throws IOException {
        ...
        props.put("group.id", "second-group"); // This is mandatory if autocommit is set to true
        ...
        FileWriter fileWriter = new FileWriter("/home/suvo/numbers.txt", true);
        ...
        try{
            while (true) {
                ...
                // In the same manner we can write messages to databases etc
